  ...
  return (
    <>
      ...
      <header className="h-header z-10 pt-4 px-4">
        <WrapperLarge className=" grid-cols-auto-1fr gap-6 mx-64 bg-light rounded-lg">
          <Logo height={62} width={142} className="mt-2 mr-3" />
          <ul className="flex flex-row flex-shrink-0 items-center text-2xl whitespace-nowrap">
            <MenuHerfList appLinks={data.appLinks} className="ml-8 mr-7 " />
